...
import { getUi, getActivePlugins, isPluginActive } from "webiny-app-site-builder/editor/selectors";
...
export default compose(
    connect(
        (state, props) => ({
            ...
            settingsActive: getActivePlugins("sb-page-element-settings")(state).length > 0
        }),
        { togglePlugin }
    ),
    withKeyHandler(),
