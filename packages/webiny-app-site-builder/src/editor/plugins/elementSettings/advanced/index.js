...
import {
    ...
    activateElement,
    togglePlugin
} from "webiny-app-site-builder/editor/actions";
import { ReactComponent as SettingsIcon } from "webiny-app-site-builder/editor/assets/icons/settings.svg";
...
export default [
    {
        name: "sb-page-element-advanced-settings",
    ...
    },
    {
        ...
        name: "sb-editor-redux-middleware-advanced-settings",
        ...
        middleware: ({ store, action, next }: Object) => {
            ...
            const sourcePlugin = getPlugins("sb-page-element").find(
            ...
            if (!onCreate || onCreate !== "skip") {
                ...
                if (onCreate && onCreate === "open-settings") {
                    ...
                    store.dispatch(togglePlugin({ name: "sb-page-element-settings-advanced" }));
                }
            }
        }
    },
    {
        name: "sb-page-element-settings-advanced",
