...
export default class ElementPreview extends React.Component<*> {
    ...
    replaceContent(element: Object, doc: Document) {
        const pl = getPlugins("sb-page-element").find(pl => pl.elementType === element.type);
        if (!pl) {
            return doc;
        }
    ...
    async generateImage() {
        ...
        // $FlowFixMe
        editor.classList.add("sb-editor-no-highlight");
        ...
        // $FlowFixMe
        editor.classList.remove("sb-editor-no-highlight");
