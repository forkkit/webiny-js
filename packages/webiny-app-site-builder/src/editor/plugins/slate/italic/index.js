...
import { ReactComponent as FormatItalicIcon } from "webiny-app-site-builder/editor/assets/icons/format_italic.svg";
...
export default () => {
    return {
        menu: [
            {
                name: "sb-slate-menu-item-italic",
