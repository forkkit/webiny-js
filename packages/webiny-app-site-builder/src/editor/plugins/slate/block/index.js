...
import { ReactComponent as AlignCenterIcon } from "webiny-app-site-builder/editor/assets/icons/format_align_center.svg";
import { ReactComponent as AlignLeftIcon } from "webiny-app-site-builder/editor/assets/icons/format_align_left.svg";
import { ReactComponent as AlignJustifyIcon } from "webiny-app-site-builder/editor/assets/icons/format_align_justify.svg";
import { ReactComponent as AlignRightIcon } from "webiny-app-site-builder/editor/assets/icons/format_align_right.svg";
...
export default () => {
    return {
        menu: [
            {
                name: "sb-slate-menu-item-typography",
        ...
        editor: [
            {
                name: "sb-slate-editor-typography",
