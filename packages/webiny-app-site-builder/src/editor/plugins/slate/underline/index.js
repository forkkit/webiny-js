...
import { ReactComponent as UnderlineIcon } from "webiny-app-site-builder/editor/assets/icons/format_underlined.svg";
...
export default () => {
    return {
        menu: [
            {
                name: "sb-slate-menu-item-underline",
        ...
        editor: [
            {
                name: "sb-slate-editor-underline",
