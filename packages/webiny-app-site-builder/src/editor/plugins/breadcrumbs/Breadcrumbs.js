...
import { getActiveElement, getElement } from "webiny-app-site-builder/editor/selectors";
import { activateElement, highlightElement } from "webiny-app-site-builder/editor/actions";
    ...
    return (
        <ul className={breadcrumbs}>
            {elements.map((el, index) => (
                ...
                >
                    <span className={"element"}>{el.type.replace("sb-page-element-", "")}</span>
