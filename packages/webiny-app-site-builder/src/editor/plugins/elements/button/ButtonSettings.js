...
import Input from "webiny-app-site-builder/editor/plugins/elementSettings/components/Input";
import ColorPicker from "webiny-app-site-builder/editor/plugins/elementSettings/components/ColorPicker";
import IconPicker from "webiny-app-site-builder/editor/plugins/elementSettings/components/IconPicker";
...
const getIcons = () => {
    if (!icons) {
        icons = getPlugins("sb-icons").reduce((icons: Array<Object>, pl: Object) => {
