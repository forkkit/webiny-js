...
import { TagsMultiAutoComplete, CategoriesAutoComplete } from "webiny-app-site-builder/admin/components";
...
export default withSiteBuilder()(PagesListFilterSettings);
