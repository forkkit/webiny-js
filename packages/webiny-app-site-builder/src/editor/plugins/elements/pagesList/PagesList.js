...
const PagesList = pure(({ data = {}, siteBuilder: { theme } }: Object = {}) => {
    const { component, ...vars } = data;
    const components = getPlugins("sb-page-element-pages-list-component");
    ...
    return (
        <Query query={loadPages} variables={variables}>
            {({ data, loading, refetch }) => {
                ...
                const pages = get(data, "siteBuilder.listPublishedPages");
...
export default withSiteBuilder()(PagesList);
