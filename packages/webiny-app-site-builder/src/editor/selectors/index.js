...
import type { ElementType, State } from "webiny-app-site-builder/types";
...
export const getContent = (state: State): Object => {
    ...
    const document = getPlugin("sb-page-element-document");
    invariant(document, `"sb-page-element-document" plugin must exist for Site Builder to work!`);
