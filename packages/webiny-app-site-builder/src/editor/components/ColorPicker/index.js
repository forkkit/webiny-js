...
import { type WithSiteBuilderPropsType } from "webiny-app-site-builder/types";

import { ReactComponent as IconPalette } from "webiny-app-site-builder/editor/assets/icons/round-color_lens-24px.svg";
...
type Props = {
    siteBuilder: WithSiteBuilderPropsType,
    onChange: Function,
...
export default withSiteBuilder()(ColorPicker);
