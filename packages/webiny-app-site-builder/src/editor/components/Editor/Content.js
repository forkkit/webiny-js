...
import { getContent, isPluginActive, getPage } from "webiny-app-site-builder/editor/selectors";
import Element from "webiny-app-site-builder/editor/components/Element";
import { Elevation } from "webiny-ui/Elevation";

const ContentContainer = styled("div")(({ theme }) => ({
    backgroundColor: get(theme, "colors.background"),
    ".webiny-sb-page-document": {
...
const Content = ({ rootElement, siteBuilder: { theme }, renderLayout, layout }) => {
    const plugins = getPlugins("sb-editor-content");
    ...
    return (
        <Elevation className={contentContainerWrapper} z={2}>
            <ContentContainer theme={theme}>
                ...
                <BaseContainer className={"webiny-sb-editor-content-preview"}>
                    {content}
                </BaseContainer>
            </ContentContainer>
        </Elevation>
...
const stateToProps = state => ({
    ...
    renderLayout: isPluginActive("sb-toolbar-preview")(state)
});
