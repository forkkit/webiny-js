...
} from "webiny-app-site-builder/editor/redux";
...
import { updateChildPaths } from "webiny-app-site-builder/editor/utils";
...
addMiddleware([ELEMENT_DROPPED], ({ store, next, action }) => {
    ...
    const plugin = getPlugins("sb-page-element").find(pl => pl.elementType === target.type);
    ...
    const targetPlugin = getPlugins("sb-page-element").find(pl => pl.elementType === target.type);
