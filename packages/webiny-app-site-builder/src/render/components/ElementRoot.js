...
class ElementRoot extends React.Component<*> {
    stylePlugins: Array<SiteBuilderRenderElementStylePluginType>;
    attributePlugins: Array<SiteBuilderRenderElementAttributesPluginType>;
    constructor() {
        super();
        this.stylePlugins = getPlugins("sb-render-page-element-style");
        this.attributePlugins = getPlugins("sb-render-page-element-attributes");
    }
