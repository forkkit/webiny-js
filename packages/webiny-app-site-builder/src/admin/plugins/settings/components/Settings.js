...
import PagesAutoComplete from "webiny-app-site-builder/admin/components/PagesAutoComplete";
...
const SiteBuilderSettings = ({ showSnackbar }) => {
    return (
        <Query query={graphql.query}>
            {({ data, loading: queryInProgress }) => {
                const settings = get(data, "settings.siteBuilder.data") || {};
                            ...
                            >
                                {({ Bind, form }) => (
                                    <SimpleForm>
                                        ...
                                        <SimpleFormHeader title="Site Builder Settings" />
                                        <SimpleFormContent>
                                            <Grid>
                                                <Cell span={6}>
                                                    <Grid>
...
export default withSnackbar()(SiteBuilderSettings);
