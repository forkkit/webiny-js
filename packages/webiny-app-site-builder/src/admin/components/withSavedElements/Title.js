...
import { ReactComponent as DeleteIcon } from "webiny-app-site-builder/editor/assets/icons/close.svg";
import { ReactComponent as EditIcon } from "webiny-app-site-builder/editor/assets/icons/edit.svg";
import { deleteElement } from "./graphql";
import EditElementDialog from "./EditElementDialog";
import createElementPlugin from "webiny-app-site-builder/admin/components/withSavedElements/createElementPlugin";
    ...
    withHandlers({
        deleteElement: ({
            ...
            showConfirmation(async () => {
                ...
                const { error } = res.siteBuilder.deleteElement;
                if (error) {
