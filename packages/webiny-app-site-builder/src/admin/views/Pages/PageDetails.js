...
import { ElementAnimation } from "webiny-app-site-builder/render/components";
...
const PageDetails = ({ pageId, history, query, showSnackbar, refreshPages }) => {
    ...
    return (
        ...
        >
            {({ data, loading }) => {
                const details = { page: get(data, "siteBuilder.page.data") || {}, loading };
                return (
                    <ElementAnimation>
                        {({ refresh }) => (
