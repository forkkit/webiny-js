...
const t = i18n.namespace("SiteBuilder.Menus");
    ...
    withCrud({
        list: {
            get: {
                ...
                response: data => get(data, "siteBuilder.menus")
            },
            delete: {
                mutation: deleteMenu,
                response: data => data.siteBuilder.deleteMenu,
        ...
        form: {
            get: {
                query: loadMenu,
                response: data => get(data, "siteBuilder.menu")
            },
            save: {
                create: createMenu,
                update: updateMenu,
                response: data => data.siteBuilder.menu,
                variables: data => ({
