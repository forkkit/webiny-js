...
import renderPlugins from "webiny-app-site-builder/render/presets/default";
...
export default [
    ...
    },
    {
        ...
        component: (
            ...
            >
                {({ data: response }) => {
                    const { favicon } = get(response, "settings.siteBuilder.data") || {};
