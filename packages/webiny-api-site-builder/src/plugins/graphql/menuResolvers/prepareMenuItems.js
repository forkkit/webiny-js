...
import { listPublishedPages } from "webiny-api-site-builder/plugins/graphql/pageResolvers/listPublishedPages";
                ...
                switch (item.type) {
                    case "page": {
                        if (!context.distinctParents.loaded) {
                            ...
                            const { Page, Category } = graphqlContext.siteBuilder.entities;
