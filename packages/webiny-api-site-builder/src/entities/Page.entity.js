...
export const pageFactory = (context: Object): Class<IPage> => {
    return class Page extends Entity {
        ...
        constructor() {
            ...
            const { user, siteBuilder, security } = context;
            const { Category } = siteBuilder.entities;
            ...
            this.attr("settings")
                .model(pageSettingsFactory({ entities: siteBuilder.entities, page: this }))
            ...
            this.attr("isErrorPage")
                .boolean()
                .setDynamic(async () => {
                    const settings = await context.siteBuilder.entities.Settings.load();
