...
const createDefaultPages = async (context: Object, { siteBuilderSettings }: Object) => {
    const { Page, Category, Menu } = context.siteBuilder.entities;
